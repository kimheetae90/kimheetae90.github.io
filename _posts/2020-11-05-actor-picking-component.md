...
!['Input Setting'](./resource/2020-11-05-actor-picking-component/input.png)
...
!['Trace Channel Setting'](./resource/2020-11-05-actor-picking-component/tracechannel.png)
...
!['Collision 세팅'](./resource/2020-11-05-actor-picking-component/collisionsetting.png)
...
!['카메라 세팅'](./resource/2020-11-05-actor-picking-component/cameradetail.png)

!['카메라 세팅 화면'](./resource/2020-11-05-actor-picking-component/cameraplay.png)
...
!['Picking 확인'](./resource/2020-11-05-actor-picking-component/picklog.png)
...
!['바닥 TraceChannel 추가'](./resource/2020-11-05-actor-picking-component/pickpanel.png)

Level상에 있는 Floor 액터를 아웃라이너에서 찾아서 위에서 만든 Trace Channel을 켜준다. 

!['Floor 콜리젼 변경'](./resource/2020-11-05-actor-picking-component/floorcollision.png)

그리고 추가했던 큐브는 움직여야하기 떄문에 무버블로 변경해준다.

!['무버블'](./resource/2020-11-05-actor-picking-component/movable.png)

이제 큐브를 잡고 이동할 수 있게 되었다.

!['무버블'](./resource/2020-11-05-actor-picking-component/pickingmove.gif)
